...
%>
<script src="${APP_PATH}/static/js/jquery/jquery-1.12.4.min.js"></script>
	        ...
	        <form class="form-horizontal">
			  ...
			  <div class="form-group">
			    <label class="col-sm-2 control-label">deptName</label>
			      <div class="col-sm-4">
			        <!-- 部门提交部门id即可 -->
			        <select class="form-control" name="deptmentId"></select>
			      </div>
			  </div>
			</form>
	      </div>
		...
		function getEmp(id){
			$.ajax({
				...
				success:function(result){
					...
					$("#empUpdateModal select").val([empData.deptmentId])
				}
			});
		}
		// 点击更新，更新员工信息
